...
%\documentclass[draft]{beamer}			% only frames, draft mode
...
% Fit the presentation to the window when first displayed
...
\begin{frame}
    ...
    \begin{columns}
		\begin{column}{0.33\paperwidth}
            \pgfmathsetlength{\imagewidth}{\imsize}%
            \pgfmathsetlength{\imagescale}{\imagewidth/1620}%
            \def\x{1001}% scalebar-x starting at golden ratio of image width of 1080px
            \def\y{978}% scalebar-y at 90% of image height of 1620px
            \begin{tikzpicture}[x=\imagescale,y=-\imagescale]
                ...
                \draw[|-|] (\x,\y) -- (\x+100,\y) node [right] {\SI{1}{\milli\meter}};
            \end{tikzpicture}%
            \centering Control
		\end{column}
		\begin{column}{0.33\paperwidth}
