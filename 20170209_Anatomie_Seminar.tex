...
\renewcommand{\imsize}{0.28\linewidth}  
\begin{frame}{Tumor metastasis, Tumor load in lungs, KP-TNIK mice. Top: KO, bottom: WT}
    \centering  
    \pgfmathsetlength{\imagewidth}{\imsize}%
...
\begin{frame}{Tumor metastasis, Overview scan with \SI{20}{\micro\meter} pixel size}
	...
	\pgfmathsetlength{\imagescale}{\imagewidth/800}%
	\def\x{494}% scalebar-x starting at golden ratio of image width of 800px = 494
	\def\y{720}% scalebar-y at 90% of image height
	\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
	\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\animategraphics[palindrome, width=0.5\linewidth]{12}{./img/tumor/mouse_tumor_rec0}{001}{263}};
	\draw[|-|] (\x,\y) -- (\x+250,\y) node [midway,above] {\SI{5}{\milli\meter}};
	\end{tikzpicture}%	
